...
def display_portfolio_summary(portfolio):
  ...
  print(tabulate(position_data, headers=['Ticker', 'Exchange', 'Quatity', 'Price', 'Market Value', '% Allocation'], tablefmt='psql', floatfmt='.2f'))
...
if __name__ == "__main__":
  ...
  portfolio = Portfolio([Position(shop, 2), Position(msft, 2), Position(googl, 30)])
